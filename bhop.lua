...
function resetPlayerMovement()
    playerVelocity = Vector3.new(0, 0, 0) -- Reset player velocity to zero
    movementPosition.position = collider.Position -- Reset position

	movementVelocity.velocity = Vector3.new(0, 0, 0)
    movementVelocity.maxForce = Vector3.new(0, 0, 0)
    movementPosition.maxForce = Vector3.new(0, 0, 0)
